# Admin/Questions/Index.vue - Complete Code

**File Path**: `source/resources/js/Pages/Admin/Questions/Index.vue`

**Purpose**: List and manage all questions for a specific game with drag-and-drop reordering
        ...
        <template #header>
            <div class="flex justify-between items-center">
                ...
                <div class="flex gap-2">
                    <Link
                        :href="route('admin.questions.create', game.id)"
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <Link
                                    :href="route('admin.questions.create-from-template', game.id)"
                                ...
                                <Link
                                    :href="route('admin.grading.index', game.id)"
                                    class="inline-flex items-center px-3 py-1.5 bg-white border border-blue-300 rounded-md text-sm text-blue-700 hover:bg-blue-50"
                                >
                                ...
                                >
                                    <div class="flex items-start justify-between gap-4">
                                        ...
                                        <div class="flex items-center gap-2">
                                            <Link
                                                :href="route('admin.questions.edit', [game.id, question.id])"
...
const deleteQuestion = (questionId) => {
    if (confirm('Are you sure you want to delete this question? This action cannot be undone.')) {
        router.delete(route('admin.questions.destroy', [props.game.id, questionId]), {
            preserveScroll: true,
        });
    }
};
...
const duplicateQuestion = (questionId) => {
    router.post(route('admin.questions.duplicate', [props.game.id, questionId]), {}, {
        preserveScroll: true,
    });
};
...
const saveOrder = () => {
    ...
    form.post(route('admin.questions.reorder', props.game.id), {
        preserveScroll: true,
        onSuccess: () => {
            isReordering.value = false;
        }
...
## Required Routes (add to web.php if not present)

```php
// In routes/web.php under Admin Questions routes
Route::prefix('admin')->middleware(['auth', 'admin'])->name('admin.')->group(function () {
    Route::prefix('games/{game}/questions')->name('questions.')->group(function () {
        ...
        Route::get('/create-from-template', [Admin\QuestionController::class, 'createFromTemplate'])->name('create-from-template');
    });
});
```
...
## Controller Method Required (add to QuestionController if not present)
...
- [ ] Cancel reorder reverts changes
- [ ] Edit button navigates correctly
- [ ] Duplicate creates copy
- [ ] Delete removes question (with confirmation)
- [ ] Quick action links work
- [ ] Responsive layout on mobile
- [ ] Total points calculation is accurate
