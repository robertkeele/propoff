...
const startSubmission = () => {
    form.post(route('submissions.start', props.game.id));
};
</script>

<template>
    <Head :title="`Play ${game.name}`" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Play: {{ game.name }}</h2>
        </template>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-8">
                        ...
                        <div class="text-center mb-8">
                            <h3 class="text-3xl font-bold text-gray-900">{{ game.name }}</h3>
                        ...
                        <div class="bg-gray-50 rounded-lg p-6 mb-8">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                                <div>
                                    <div class="text-3xl font-bold text-indigo-600">{{ game.questions.length }}</div>
                        ...
                        <div class="mb-8">
                            ...
                            <ul class="list-disc list-inside space-y-2 text-gray-600">
                                <li>Answer all {{ game.questions.length }} questions to the best of your ability</li>
                                ...
                                <li v-if="game.lock_date">
                                    Lock Date: {{ new Date(game.lock_date).toLocaleString() }}
                                </li>
                            </ul>
                        </div>
