...
const startGame = (gameId) => {
    router.post(route('submissions.start', gameId));
};
</script>

<template>
    <Head title="Available Games" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Available Games</h2>
        </template>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div v-if="games.data.length === 0" class="text-center py-12">
                            <p class="text-gray-500">No games available to play at this time.</p>
                        </div>
                        ...
                        <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            >
                                <div class="flex-1">
                                    ...
                                    <p class="mt-2 text-gray-600 text-sm line-clamp-3">{{ game.description }}</p>
