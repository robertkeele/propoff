            ...
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">
                        Modify question for {{ group.name }}
                    </p>
                </div>
                <Link
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-blue-700 mt-1">
                                ...
                                <span v-if="question.is_custom" class="ml-2 px-2 py-0.5 bg-blue-100 text-blue-800 rounded text-xs font-semibold">Custom Question</span>
                            </p>
                        </div>
                    </div>
                </div>
...
const submit = () => {
    ...
    .patch(route('captain.groups.questions.update', [props.group.id, props.question.id]), {
        onSuccess: () => {
